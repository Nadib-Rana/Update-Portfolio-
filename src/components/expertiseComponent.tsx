...
const demoExpertise: IExpertise[] = [
  {
    _id: "1",
    role: "Full-stack Developer",
    institution: "9AM SOLUTION",
    year: "2024",
  },
  {
    _id: "2",
    role: "Freelance Web Developer",
    institution: "Self-employed (HTML Email Signatures)",
    year: "2021–Present",
  },
  {
    _id: "3",
...
const ExpertiseComponent: React.FC = () => {
  ...
  return (
    <section
      id="expertise"
      className="py-16 bg-gradient-to-b from-black via-gray-900 to-gray-800 text-white"
    >
