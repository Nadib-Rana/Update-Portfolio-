...
const demoBio: IBio = {
  ...
  description:
    "I'm a Computer Science graduate passionate about building scalable, user-centric applications. With expertise in MERN stack and HTML email signature design, I blend technical precision with creative presentation.",
  quote: "Code is poetry when it solves real problems beautifully.",
  profilePhoto: "https://media.licdn.com/dms/image/v2/D4D03AQEvb_YTBK9TqQ/profile-displayphoto-scale_400_400/B4DZjBlM0.H0Ag-/0/1755594411954?e=1759363200&v=beta&t=s2UzbviI6KLDWBnBPK2wn83ErYBsR47fkGsSaMVi9R4",
  socialMediaLinks: {
    linkedin: "https://linkedin.com/in/nadib",
    facebook: "https://facebook.com/nadib.dev",
    instagram: "https://instagram.com/nadib.codes",
  },
};
